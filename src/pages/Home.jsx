          ...
          <div style={{ position: "relative" }}>
            ...
            <div className="u-termcard" style={{ position: "absolute", left: -26, bottom: -26, width: 280, background: "#fff", border: "1px solid #E6E9EF", borderRadius: 16, boxShadow: "0 18px 44px -14px rgba(14,26,43,0.28)", padding: 20 }}>
              <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 14 }}>
                <span style={{ fontSize: 12, fontWeight: 700, letterSpacing: "0.06em", textTransform: "uppercase", color: "#667085" }}>Sample term sheet</span>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 11 }}>
                ...
                <div style={{ height: 1, background: "#EEF1F5" }} />
                <div style={{ display: "flex", alignItems: "baseline", justifyContent: "space-between" }}><span style={{ fontSize: 14, color: "#667085" }}>Funds in</span><span style={{ fontFamily: SCH, fontWeight: 800, fontSize: 17, color: "#1A56C4" }}>5-7 days</span></div>
              </div>
            </div>
          </div>
        </div>
