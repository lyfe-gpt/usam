        ...
        <div style={{ maxWidth: 880, margin: "0 auto" }}>
          <div style={{ background: "linear-gradient(150deg,#123E96,#1A56C4)", borderRadius: 20, padding: "36px 40px", display: "flex", alignItems: "center", justifyContent: "space-between", gap: 28, flexWrap: "wrap" }}>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 12, flexWrap: "wrap" }}>
              ...
              <a href="tel:512-617-9400" className="btn-ghost-light" style={{ display: "inline-flex", alignItems: "center", gap: 8, color: "#fff", textDecoration: "none", fontWeight: 700, fontSize: 16, padding: "13px 22px", borderRadius: 999, border: "1.5px solid rgba(255,255,255,0.5)" }}>
