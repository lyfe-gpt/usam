        ...
        <div className="ftr-grid" style={{ display: "grid", gridTemplateColumns: "1.4fr 1fr 1fr 1.2fr", gap: 48, paddingBottom: 48, borderBottom: "1px solid #21324A" }}>
          <div>
            <div style={{ marginBottom: 18 }}>
              <img src="https://lirp.cdn-website.com/e6bfcade/dms3rep/multi/opt/whiteLogo+copy-230w.png" alt="USAM I Fund" style={{ height: 48, width: "auto", display: "block" }} />
            </div>
          ...
          <div>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 11, fontSize: 14.5 }}>
              ...
              <Link to="/apply" className="ftr-lnk" style={lnk}>Apply now</Link>
            </div>
          </div>
