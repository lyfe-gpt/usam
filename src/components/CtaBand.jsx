    ...
    <section className="sec" style={{ background: "#fff", padding: "32px 32px 88px" }}>
      ...
      >
        ...
        <div style={{ display: "flex", alignItems: "center", gap: withPhone ? 14 : 16, flexWrap: "wrap" }}>
          ...
          {withPhone && (
            <a href="tel:512-617-9400" className="btn-ghost-light" style={{ color: "#fff", textDecoration: "none", fontWeight: 700, fontSize: 17, padding: "16px 28px", borderRadius: 999, border: "1.5px solid rgba(255,255,255,0.5)" }}>512-617-9400</a>
          )}
        </div>
      </div>
    </section>
